...
writematrix(rain_asia,'rain_asia.csv')
writematrix(rain_africa,'rain_africa.csv')
writematrix(rain_oceania,'rain_oceania.csv')
writematrix(rain_europe,'rain_europe.csv')
writematrix(rain_NA,'rain_NA.csv')
writematrix(rain_SA,'rain_SA.csv')
writematrix(rain_global,'rain_global.csv')